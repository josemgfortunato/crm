...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="78%"><h3 class="box-title">Tabela de Usuários</h3></td>
    <td width="22%">
            <div align="right">
...
<?php
// do { 
$sql_user = mysqli_query($conexao,"select * from tb_administrador WHERE ID_ADMINISTRADOR > '1' AND ADMINISTRADOR_STATUS < '3' ");
...
<td><div align="center"><a href="user.php?ID_ADMINISTRADOR=<?php echo $ID_ADMINISTRADOR; ?>"><i class="fa fa-refresh"></i></a></div></td>
<td><div align="center"><a href="excluir-user.php?ID_ADMINISTRADOR=<?php echo $ID_ADMINISTRADOR; ?>"><i class="fa fa-close" style="color:#FF0000"></i></a></div></td>
</tr>
<?php
