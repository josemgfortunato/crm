...
$F_SUPERVISOR		= isset($_GET['F_SUPERVISOR']) ? $_GET['F_SUPERVISOR'] : '';

//////////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////	SELECIONA o LOG		/////////////////////
$sql_log = mysqli_query($conexao,"select * from tb_log_dist_leads_sup ORDER BY LOG_DIST_COD DESC");
...
LEADS_SUPERVISOR='$F_SUPERVISOR',
LEADS_DISTRIBUIDO_SUP='1',
LEADS_DISTRIBUIDO_SUP_DATA='$LEADS_DISTRIBUIDO_SUP_DATA',
...
mysqli_query ($conexao,"INSERT INTO tb_log_dist_leads_sup (ID_LOG_DIST, LOG_DIST_USER, LOG_DIST_SUPERVISOR, LOG_DIST_COD, LOG_DIST_LEADS, F_USER_REGISTRO, DATA_CADATRO, HORA_CADASTRO, IP_CADASTRO, F_USER_ULT_ALTERACAO, DATA_ULT_ALTERACAO, HORA_ULT_ALTERACAO, IP_ULT_ALTERACAO) VALUES (null, '$ID_USER', '$F_SUPERVISOR', '$LOG_DIST_COD', '$ID_LEADS', '$F_USER_REGISTRO', '$DATA_CADATRO', '$HORA_CADASTRO', '$IP_CADASTRO', '$F_USER_ULT_ALTERACAO', '$DATA_ULT_ALTERACAO', '$HORA_ULT_ALTERACAO', '$IP_ULT_ALTERACAO')");
...
$t_leads = mysqli_query($conexao,"select count(*) as total FROM tb_log_dist_leads_sup WHERE LOG_DIST_COD = '$LOG_DIST_COD' ");
$t_leads = mysqli_fetch_array($t_leads);
$t_leads = $t_leads[0];


$sql_operador = mysqli_query($conexao,"select * from tb_administrador WHERE ID_ADMINISTRADOR = '$F_SUPERVISOR' ");
...
alert ('(<?php echo $t_leads; ?> LEADS) enviados para o Supervisor(a) (<?php echo $ADMINISTRADOR_NOME; ?>)!');
location.href = 'principal-leads-distribuir.php';
</script>