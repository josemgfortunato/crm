...
///////////////////////////////////////////////////////
$sql_result = mysqli_query($conexao,"select * from tb_msg WHERE ID_MSG = '1' ");
$val_msg = mysqli_fetch_object($sql_result);  
///////////////////////////////////////////////////////

$ID_MSG 			= isset($val_msg->ID_MSG) ? $val_msg->ID_MSG : '';
$MSG_STATUS 		= isset($val_msg->MSG_STATUS) ? $val_msg->MSG_STATUS : '';
$MSG_TEXTO 			= isset($val_msg->MSG_TEXTO) ? $val_msg->MSG_TEXTO : '';
$MSG_OBS			= isset($val_msg->MSG_OBS) ? $val_msg->MSG_OBS : '';
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Mensagem do Dia</a></li>
      </ol>
    </section>
...
//ELSEIF($ID_BANCO > '')
echo "action='mensagem-dia-alterar-actions.php'"; 
?> method='post' name="formulario" >
<input type="hidden" id="ID_MSG" name="ID_MSG" value="<?php echo $ID_MSG; ?>">
<input type="hidden" id="MSG_USER" name="MSG_USER" value="<?php echo $ID_USER; ?>">
