  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Distribuir Leads Supervisor</a></li>
      </ol>
    </section>
<br>
  <!-- Main content -->
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="78%"><h3 class="box-title">Tabela de Distribuição de Leads para Supervisor</h3></td>
<!--
    <td width="22%">
            <div align="right">
...
<div class="box-body">
<form name="formulario" action="leads-distribui-supervisor-actions.php" method="GET">
...
<select id="F_SUPERVISOR" name="F_SUPERVISOR" class="form-control" required="required" >
<option value=""></option>
<?php 
...
$sql_leads = mysqli_query($conexao,"select * from tb_leads WHERE LEADS_STATUS = '' AND LEADS_DISTRIBUIDO = '' AND LEADS_DISTRIBUIDO_SUP = '' LIMIT 800 ");
$cont = 0;
...
<div align="center">
<input type="submit" class="btn btn-danger" value="ENVIAR LEADS" />
</div>
<br>
<br>
            </div>
