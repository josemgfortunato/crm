...
<input type="text" class="form-control" id="CLIENTE_CPF" name="CLIENTE_CPF" placeholder="000.000.000-00 " value="<?php echo $CLIENTE_CPF; ?>" >
</div>
...
elseif($VALOR_CONTR_ENTR_PARC == '3')
echo "<option value='3'> À Vista </option>";
?>
