...
$sql_juri_result = mysqli_query($conexao,"select * from tb_laudo WHERE LAUDO_STATUS = '' AND LAUDO_ENVIO = '1' ORDER BY ID_LAUDO DESC ");
...
//if($ID_LAUDO == '')	{
?>
<a href="?ID_LEADS=<?php echo $ID_LEADS; ?>&&ID_LEADS_JURIDICO=<?php echo $ID_LEADS_JURIDICO; ?>"><i class="fa fa-paper-plane-o" style="color:#003300"></i></a></div>
<?php
//	}
?>	
</td>
