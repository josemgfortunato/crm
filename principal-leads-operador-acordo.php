...
<th width="40"><div align="center">ENV. OP. ADM</div></th>
...
//if($val_status == '1')	{
$sql_leads = mysqli_query($conexao,"select * from tb_leads WHERE $val_user (LEADS_STATUS = '1') ORDER BY ID_LEADS DESC ");
//}	elseif($val_status == '4')	{
...
//}	else	{
//$sql_leads = mysqli_query($conexao,"select * from tb_leads WHERE $val_user (LEADS_STATUS = '' OR LEADS_STATUS = '2' OR LEADS_STATUS = '3') ORDER BY LEADS_PRIORIDADE DESC LIMIT 500 ");
//}
...
$sql_env_leads = mysqli_query($conexao,"select * from tb_leads_op_adm WHERE OP_ADM_LEADS = '$ID_LEADS' ");
...
if($ID_OP_ADM == '')	{
?>
<a href="operador-envia-op-adm.php?ID_LEADS=<?php echo $ID_LEADS; ?>"><i class="fa fa-paper-plane-o" style="color:#003300"></i></a></div></td>
<?php
	}
?>	
