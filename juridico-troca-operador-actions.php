...
$val_operador	= isset($_GET['val_operador']) ? $_GET['val_operador'] : '';
$LEADS_STATUS = '';
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////	SELECIONA o LOG		/////////////////////
...
$sql_result = mysqli_query($conexao,"select * from tb_leads_juridico WHERE LEADS_JURIDICO_LEADS = '$id' ");
...
LEADS_JURIDICO_DISTRIBUIDO_DATA='$LEADS_DISTRIBUIDO_DATA',
...
WHERE LEADS_JURIDICO_LEADS='$LEADS_JURIDICO_LEADS';";
...
location.href = 'principal-juridico-troca-operador.php';
</script>