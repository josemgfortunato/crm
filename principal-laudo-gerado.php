...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Jurídico - Laudo Gerado |
        <small>painel de controle</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Jurídico - Laudo Gerado</a></li>
      </ol>
    </section>
<br>
  <!-- Main content -->
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="78%"><h3 class="box-title">Tabela - Jurídico
<strong>
<?php
//if($val_status == '1')
echo ' - " Laudo Gerado " ';
...
<th width="40"><div align="center">Nº CON.</div></th>
<th width="40"><div align="center">LAUDO</div></th>
<th width="40"><div align="center">PRINT</div></th>
<th width="40"><div align="center">DOC. PROC.</div></th>
<th width="40"><div align="center">ENV. PROCESSUAL</div></th>
<?php
if($USER_TIPO == '1')
...
//$sql_juri_result = mysqli_query($conexao,"select * from tb_leads_juridico WHERE $val_user (LEADS_JURIDICO_STATUS_DOC = '1' AND LEADS_JURIDICO_CONSUMIDOR_ENVIADO = '1' AND LEADS_JURIDICO_CONSUMIDOR_RECEBIDO = '1' AND LEADS_JURIDICO_STATUS = '1') ORDER BY ID_LEADS_JURIDICO DESC ");

$sql_juri_result = mysqli_query($conexao,"select * from tb_laudo WHERE LAUDO_STATUS = '1' ORDER BY ID_LAUDO DESC ");
while($val_leads_juri = mysqli_fetch_object($sql_juri_result)):      

$ID_LAUDO		 	= isset($val_leads_juri->ID_LAUDO) ? $val_leads_juri->ID_LAUDO : '';
$LAUDO_USER		 	= isset($val_leads_juri->LAUDO_USER) ? $val_leads_juri->LAUDO_USER : '';
$LAUDO_STATUS		= isset($val_leads_juri->LAUDO_STATUS) ? $val_leads_juri->LAUDO_STATUS : '';
$LAUDO_TIPO			= isset($val_leads_juri->LAUDO_TIPO) ? $val_leads_juri->LAUDO_TIPO : '';
$LAUDO_LEADS		= isset($val_leads_juri->LAUDO_LEADS) ? $val_leads_juri->LAUDO_LEADS : '';
$LAUDO_JURIDICO		= isset($val_leads_juri->LAUDO_JURIDICO) ? $val_leads_juri->LAUDO_JURIDICO : '';

$LAUDO_ENVIO_DATA	= isset($val_leads_juri->LAUDO_ENVIO_DATA) ? $val_leads_juri->LAUDO_ENVIO_DATA : '';
$LAUDO_ENVIO_DATA_DIA = substr($LAUDO_ENVIO_DATA, 8, 4);
$LAUDO_ENVIO_DATA_MES = substr($LAUDO_ENVIO_DATA, 5, 2);
$LAUDO_ENVIO_DATA_ANO = substr($LAUDO_ENVIO_DATA, 0, 4);
$LAUDO_ENVIO_DATA = $LAUDO_ENVIO_DATA_DIA.'/'.$LAUDO_ENVIO_DATA_MES.'/'.$LAUDO_ENVIO_DATA_ANO;

$LAUDO_PROCESSUAL_DOC		= isset($val_leads_juri->LAUDO_PROCESSUAL_DOC) ? $val_leads_juri->LAUDO_PROCESSUAL_DOC : '';
$LAUDO_ENVIO_PROCESSUAL		= isset($val_leads_juri->LAUDO_ENVIO_PROCESSUAL) ? $val_leads_juri->LAUDO_ENVIO_PROCESSUAL : '';

$LAUDO_ARQUIVO				= isset($val_leads_juri->LAUDO_ARQUIVO) ? $val_leads_juri->LAUDO_ARQUIVO : '';

///////////////////////////////////////////////////////
$sql_leads_val = mysqli_query($conexao,"select * from tb_ficha_intermediacao WHERE FICHA_INTER_LEADS = '$LAUDO_LEADS' ");
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////////////////////////
$sql_leads = mysqli_query($conexao,"select * from tb_leads WHERE ID_LEADS = '$LAUDO_LEADS' ");
...
///////////////////////////////////////////////////////////////////////////////////////
$sql_operador = mysqli_query($conexao,"select * from tb_administrador WHERE ID_ADMINISTRADOR = '$LAUDO_USER' ");
...
if($LAUDO_ENVIO_PROCESSUAL == '1')
$f_color = "bgcolor='#66ff66'";
else
$f_color = "";
?>
...
?> </div></td>
-->
<td <?php echo $f_color; ?>><div align="center"> <?php echo $LAUDO_ENVIO_DATA; ?> </div></td>
<td <?php echo $f_color; ?>><div align="center"><a href="juridico-ficha-intermediacao.php?ID_LEADS=<?php echo $ID_LEADS; ?>&&ID_LEADS_JURIDICO=<?php echo $LAUDO_JURIDICO; ?>"><i class="fa fa-clipboard" style="color:#00FF00"></i></a></div></td>

<td <?php echo $f_color; ?>><div align="center"><a href="juridico-leads-doc-aguardando-consumidor.php?ID_LEADS=<?php echo $ID_LEADS; ?>&&ID_LEADS_JURIDICO=<?php echo $LAUDO_JURIDICO; ?>"><i class="fa fa-folder-open" style="color:#990033"></i></a></div></td>

<td <?php echo $f_color; ?>><div align="center"><a href="juridico-consumidor-protocolo-visualiza.php?ID_LEADS=<?php echo $ID_LEADS; ?>&&ID_LEADS_JURIDICO=<?php echo $LAUDO_JURIDICO; ?>"><i class="fa fa-clipboard" style="color:#003300"></i></a></div></td>

<td <?php echo $f_color; ?>><div align="center"><a href="laudo.php?ID_LEADS=<?php echo $ID_LEADS; ?>&&LAUDO_JURIDICO=<?php echo $LAUDO_JURIDICO; ?>&&ID_LAUDO=<?php echo $ID_LAUDO; ?>"><i class="fa fa-file-text" style="color:#0000FF"></i></a></div></td>
</td>
...
if($LAUDO_TIPO == '1')	{
?>
<a href="laudo-pericial.php?ID_LEADS=<?php echo $ID_LEADS; ?>&&LAUDO_JURIDICO=<?php echo $LAUDO_JURIDICO; ?>&&ID_LAUDO=<?php echo $ID_LAUDO; ?>"><i class="fa fa-print" style="color:#ff0000"></i></a>
<?php
}	elseif($LAUDO_TIPO == '2')	{
?>
<a href="laudo-docs/<?php echo $LAUDO_ARQUIVO; ?>" target="_blank"><i class="fa fa-print" style="color:#0000FF"></i></a>
<?php
	}
?>	
</div></td>
...
<td <?php echo $f_color; ?>><div align="center"><a href="laudo-doc-processual.php?ID_LEADS=<?php echo $ID_LEADS; ?>"><i class="fa fa-folder-open" style="color:#000000"></i></a></div></td>
</td>

<td <?php echo $f_color; ?>>
<div align="center">
<?php
if(($LAUDO_PROCESSUAL_DOC == '1') and ($LAUDO_ENVIO_PROCESSUAL == ''))	{
?>
<a href="laudo-enviar-processual.php?ID_LEADS=<?php echo $ID_LEADS; ?>&&ID_LAUDO=<?php echo $ID_LAUDO; ?>"><i class="fa fa-paper-plane-o" style="color:#003300"></i></a></div>
<?php
	}
?>	
</td>
