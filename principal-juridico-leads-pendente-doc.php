...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Jurídico - Pasta Pendente Doc |
        <small>painel de controle</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Jurídico - Pasta Pendente Doc</a></li>
      </ol>
    </section>
<br>
  <!-- Main content -->
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="78%"><h3 class="box-title">Tabela - Leads Pendente Doc
<strong>
<?php
//if($val_status == '1')
//echo ' - " Acordo/ Revisão " ';
...
<td><div align="center"><a href="juridico-leads-pendente-doc.php?ID_LEADS=<?php echo $ID_LEADS; ?>"><i class="fa fa-folder-open" style="color:#990033"></i></a></div></td>
<td>
<div align="center">
<?php
if($LEADS_JURIDICO_STATUS_DOC == '1')	{
?>
<a href="juridico-enviar-consumidor.php?ID_LEADS=<?php echo $ID_LEADS; ?>&&ID_LEADS_JURIDICO=<?php echo $ID_LEADS_JURIDICO; ?>"><i class="fa fa-paper-plane-o" style="color:#003300"></i></a></div>
<?php
	}
?>	
</td>
