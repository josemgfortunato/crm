...
<th width="40"><div align="center">ENV. OP</div></th>
...
<td><div align="center"><a href="juridico-consumidor-protocolo.php?ID_LEADS=<?php echo $ID_LEADS; ?>&&ID_LEADS_JURIDICO=<?php echo $ID_LEADS_JURIDICO; ?>"><i class="fa fa-clipboard" style="color:#003300"></i></a></div></td>

<td>
<div align="center">
<?php
if($ID_CONSUMIDOR_PROTOCOLO > '')	{
?>
<a href="juridico-consumidor-protocolo-enviar.php?ID_LEADS=<?php echo $ID_LEADS; ?>&&ID_LEADS_JURIDICO=<?php echo $ID_LEADS_JURIDICO; ?>"><i class="fa fa-paper-plane-o" style="color:#003300"></i></a></div>
<?php
	}
?>	
</td>
