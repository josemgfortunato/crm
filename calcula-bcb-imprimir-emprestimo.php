...
<table width="1000" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#e2e2e2">
  ...
  Consultor(a): <?php echo $CAL_ADMINISTRADOR_NOME; ?>&nbsp;</span><br />
      ...
      <table width="960" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td width="80">&nbsp;</td>
          <td height="30" colspan="2" bgcolor="#002060"><div align="center" class="style10">Empréstimo atual com parcelas fixas</div></td>
          <td width="100">&nbsp;</td>
          <td colspan="2" bgcolor="#002060"><div align="center" class="style10">Empréstimo corrigido com parcelas fixas</div></td>
          <td width="80">&nbsp;</td>
        </tr>
        <tr>
          <td>&nbsp;</td>
        ...
        <tr>
          <td height="30">&nbsp;</td>
          <td><span class="style12">Valor Empréstimo</span></td>
        ...
        <tr>
          <td height="30">&nbsp;</td>
          <td class="style12">Nº de meses </td>
