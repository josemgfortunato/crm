...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Jurídico - Laudo Fechado |
        <small>painel de controle</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Jurídico - Laudo Fechado</a></li>
      </ol>
    </section>
<br>
  <!-- Main content -->
...
<th width="40"><div align="center">ENV. LAUDO</div></th>
<?php
if($USER_TIPO == '1')
...
<td <?php echo $f_color; ?>><div align="center"><a href="juridico-ficha-intermediacao.php?ID_LEADS=<?php echo $ID_LEADS; ?>&&ID_LEADS_JURIDICO=<?php echo $ID_LEADS_JURIDICO; ?>"><i class="fa fa-clipboard" style="color:#00FF00"></i></a></div></td>
<td <?php echo $f_color; ?>><div align="center"><a href="juridico-leads-doc-aguardando-consumidor.php?ID_LEADS=<?php echo $ID_LEADS; ?>&&ID_LEADS_JURIDICO=<?php echo $ID_LEADS_JURIDICO; ?>"><i class="fa fa-folder-open" style="color:#990033"></i></a></div></td>

<td <?php echo $f_color; ?>><div align="center"><a href="juridico-consumidor-protocolo-visualiza.php?ID_LEADS=<?php echo $ID_LEADS; ?>&&ID_LEADS_JURIDICO=<?php echo $ID_LEADS_JURIDICO; ?>"><i class="fa fa-clipboard" style="color:#003300"></i></a></div></td>

<td <?php echo $f_color; ?>><div align="center"><a href="laudo-juridico-pagamento.php?ID_LEADS=<?php echo $ID_LEADS; ?>"><i class="fa fa-dollar" style="color:#0000FF"></i></a></div></td>
</td>
<td <?php echo $f_color; ?>>
<div align="center">
<?php
if($ID_LAUDO == '')	{
?>
<a href="juridico-enviar-laudo.php?ID_LEADS=<?php echo $ID_LEADS; ?>&&ID_LEADS_JURIDICO=<?php echo $ID_LEADS_JURIDICO; ?>"><i class="fa fa-paper-plane-o" style="color:#003300"></i></a></div>
<?php
	}
?>	
</td>
