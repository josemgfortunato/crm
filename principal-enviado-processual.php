...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Enviado para o Processual |
        <small>painel de controle</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Enviado para o Processual</a></li>
      </ol>
    </section>
<br>
  <!-- Main content -->
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="78%"><h3 class="box-title">Tabela - 
<strong>
<?php
//if($val_status == '1')
echo ' - " Enviado para o Processual " ';
//elseif($val_status == '7')
//echo ' - " Em Negociação " ';
?></strong>    </h3></td>
<!--
...
$sql_juri_result = mysqli_query($conexao,"select * from tb_laudo WHERE LAUDO_STATUS = '1' AND LAUDO_ENVIO_PROCESSUAL = '1' ORDER BY ID_LAUDO DESC ");
