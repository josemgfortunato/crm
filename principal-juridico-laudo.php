...
if($val_status == '7')	{
$sql_juri_result = mysqli_query($conexao,"select * from tb_leads_juridico WHERE $val_user (LEADS_JURIDICO_STATUS_DOC = '1' AND LEADS_JURIDICO_CONSUMIDOR_ENVIADO = '1' AND LEADS_JURIDICO_CONSUMIDOR_RECEBIDO = '1' AND LEADS_JURIDICO_STATUS = '7') ORDER BY ID_LEADS_JURIDICO DESC ");
}	else	{
$sql_juri_result = mysqli_query($conexao,"select * from tb_leads_juridico WHERE $val_user (LEADS_JURIDICO_STATUS_DOC = '1' AND LEADS_JURIDICO_CONSUMIDOR_ENVIADO = '1' AND LEADS_JURIDICO_CONSUMIDOR_RECEBIDO = '1' AND LEADS_JURIDICO_STATUS = '') ORDER BY ID_LEADS_JURIDICO DESC ");
}
