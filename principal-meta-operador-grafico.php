...
$sql_equipe = mysqli_query($conexao,"select * from tb_supervisor_user WHERE SUPERVISOR_USER_STATUS = '1' AND SUPERVISOR_USER_OPERADOR = '$ID_USER' ");
$val_equipe = mysqli_fetch_object($sql_equipe);  
///////////////////////////////////////////////////////
$SUPERVISOR_USER_EQUIPE				= isset($val_equipe->SUPERVISOR_USER_EQUIPE) ? $val_equipe->SUPERVISOR_USER_EQUIPE : '';
...
$META_VALOR_EQUIPE		= isset($val_meta->META_VALOR_EQUIPE1) ? $val_meta->META_VALOR_EQUIPE1 : '';
$META_VALOR_OPERADOR	= isset($val_meta->META_VALOR_OPERADOR1) ? $val_meta->META_VALOR_OPERADOR1 : '';
}	elseif($SUPERVISOR_USER_EQUIPE == '2')	{
$META_VALOR_OPERADOR	= isset($val_meta->META_VALOR_EQUIPE2) ? $val_meta->META_VALOR_EQUIPE2 : '';
$META_VALOR_OPERADOR	= isset($val_meta->META_VALOR_OPERADOR2) ? $val_meta->META_VALOR_OPERADOR2 : '';
}	elseif($SUPERVISOR_USER_EQUIPE == '3')	{
$META_VALOR_OPERADOR	= isset($val_meta->META_VALOR_EQUIPE3) ? $val_meta->META_VALOR_EQUIPE3 : '';
$META_VALOR_OPERADOR	= isset($val_meta->META_VALOR_OPERADOR3) ? $val_meta->META_VALOR_OPERADOR3 : '';
}	elseif($SUPERVISOR_USER_EQUIPE == '4')	{
$META_VALOR_OPERADOR	= isset($val_meta->META_VALOR_EQUIPE4) ? $val_meta->META_VALOR_EQUIPE4 : '';
$META_VALOR_OPERADOR	= isset($val_meta->META_VALOR_OPERADOR4) ? $val_meta->META_VALOR_OPERADOR4 : '';
}

if($META_VALOR_OPERADOR == '')
$VAL_META_VALOR_OPERADOR = '00,00';
else
$VAL_META_VALOR_OPERADOR = $META_VALOR_OPERADOR;

$VAL_META_VALOR_OPERADOR = str_replace(".","", $VAL_META_VALOR_OPERADOR);
$VAL_META_VALOR_OPERADOR = str_replace(",","", $VAL_META_VALOR_OPERADOR);

//$t_count = mysqli_query($conexao,"select count(*) as total FROM tb_supervisor_user WHERE SUPERVISOR_USER_STATUS = '1' AND SUPERVISOR_USER_EQUIPE = '$SUPERVISOR_USER_EQUIPE' ");
//$t_count = mysqli_fetch_array($t_count);
//$t_count = $t_count[0];

//$META_VALOR_OPERADOR = str_replace(".","", $META_VALOR_OPERADOR);
//$META_VALOR_OPERADOR = str_replace(",","", $META_VALOR_OPERADOR);

//echo $META_VALOR_OPERADOR = $META_VALOR_OPERADOR / $t_count;
//echo "<br>";
//echo $META_VALOR_OPERADOR = substr($META_VALOR_OPERADOR, 0, -2);
//$META_VALOR_OPERADOR = number_format($META_VALOR_OPERADOR, 2, ',', '.');

//$META_VALOR_OPERADOR = number_format($META_VALOR_OPERADOR, 2,",","");

//$VAL_META_VALOR_OPERADOR = $VAL_META_VALOR_OPERADOR / $t_count;
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
$sql_total = mysqli_query($conexao,"select sum(cast(replace(replace(VALOR_CONTR_VALOR, '.', ''), ',', '.') as decimal(10,2))) FROM tb_valor_contratacao WHERE VALOR_CONTR_STATUS = '1' AND MONTH(VALOR_CONTR_DATA_PGTO) = '$F_MES' AND VALOR_CONTR_USER = '$ID_USER' ");
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
$sql_persp = mysqli_query($conexao,"select sum(cast(replace(replace(VALOR_CONTR_VALOR, '.', ''), ',', '.') as decimal(10,2))) FROM tb_valor_contratacao WHERE VALOR_CONTR_STATUS = '2' AND MONTH(VALOR_CONTR_DATA_PGTO) = '$F_MES' AND VALOR_CONTR_USER = '$ID_USER' ");
...
<div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
<form action='principal-meta-operador-grafico.php' method='get' name="formulario" >
...
R$ <?php echo $META_VALOR_OPERADOR; ?> &quot;</strong></span></div></td>
      ...
      datasets: [
        {
          ...
          data                : ['', <?php echo $VAL_META_VALOR_OPERADOR; ?>, '']
        },
        {
          label               : 'Realizado',
          fillColor           : '#ff0000',
