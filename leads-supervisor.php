...
<?php 
IF($ID_LEADS == '')
echo "action='leads-supervisor-cadastrar-actions.php'"; 
ELSEIF($ID_LEADS > '')
echo "action='leads-supervisor-alterar-actions.php'"; 
...
<input type="text" class="form-control" id="LEADS_DATA" name="LEADS_DATA" placeholder="insira a data" value="<?php echo $LEADS_DATA; ?>" required readonly />
</div>
...
<select id="LEADS_OPERADOR" name="LEADS_OPERADOR" class="form-control" required="required" >
<option value=""></option>
<?php 
/*
...
echo "<option value='1'> Financiamento Carro </option>";
elseif($LEADS_TIPO_FINANCIAMENTO == '2')
echo "<option value='2'> Financiamento Moto </option>";
elseif($LEADS_TIPO_FINANCIAMENTO == '3')
echo "<option value='3'> Financiamento Caminhão </option>";
elseif($LEADS_TIPO_FINANCIAMENTO == '4')
echo "<option value='4'> Emprestimo </option>";
?>
<option value=""> </option>
<option value="1"> Financiamento Carro </option>
<option value="2"> Financiamento Moto </option>
<option value="3"> Financiamento Caminhão </option>
