...
mysqli_query ($conexao,"INSERT INTO tb_metas (ID_META, META_USER, META_STATUS, META_DATA, META_MES, META_ANO, META_VALOR, META_VALOR_EQUIPE1, META_VALOR_OPERADOR1, META_VALOR_EQUIPE2, META_VALOR_OPERADOR2, META_VALOR_EQUIPE3, META_VALOR_OPERADOR3, META_VALOR_EQUIPE4, META_VALOR_OPERADOR4, META_OBS, F_USER_REGISTRO, DATA_CADATRO, HORA_CADASTRO, IP_CADASTRO, F_USER_ULT_ALTERACAO, DATA_ULT_ALTERACAO, HORA_ULT_ALTERACAO, IP_ULT_ALTERACAO) VALUES (null, '$META_USER', '$META_STATUS', '$META_DATA', '$META_MES', '$META_ANO', '$META_VALOR', '$META_VALOR_EQUIPE1', '$META_VALOR_OPERADOR1', '$META_VALOR_EQUIPE2', '$META_VALOR_OPERADOR2', '$META_VALOR_EQUIPE3', '$META_VALOR_OPERADOR3', '$META_VALOR_EQUIPE4', '$META_VALOR_OPERADOR4', '$META_OBS', '$F_USER_REGISTRO', '$DATA_CADATRO', '$HORA_CADASTRO', '$IP_CADASTRO', '$F_USER_ULT_ALTERACAO', '$DATA_ULT_ALTERACAO', '$HORA_ULT_ALTERACAO', '$IP_ULT_ALTERACAO')");
