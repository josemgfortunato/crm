...
///////////////////////////////////////////////////////
$sql_result = mysqli_query($conexao,"select * from tb_bancos WHERE ID_BANCO = '$ID_BANCO' ");
$val_bancos = mysqli_fetch_object($sql_result);  
///////////////////////////////////////////////////////

$ID_BANCO 				= isset($val_bancos->ID_BANCO) ? $val_bancos->ID_BANCO : '';
$BANCO_STATUS 			= isset($val_bancos->BANCO_STATUS) ? $val_bancos->BANCO_STATUS : '';
$BANCO_NOME 			= isset($val_bancos->BANCO_NOME) ? $val_bancos->BANCO_NOME : '';
$BANCO_OBS				= isset($val_bancos->BANCO_OBS) ? $val_bancos->BANCO_OBS : '';
...
ELSEIF($ID_BANCO > '')
echo "action='bancos-alterar-actions.php'"; 
?> method='post' name="formulario" >
<input type="hidden" id="ID_BANCO" name="ID_BANCO" value="<?php echo $ID_BANCO; ?>">
<input type="hidden" id="BANCO_USER" name="BANCO_USER" value="<?php echo $ID_USER; ?>">
...
<input type="text" class="form-control" id="BANCO_NOME" name="BANCO_NOME" placeholder="insira o banco" value="<?php echo $BANCO_NOME; ?>" required>
</div>


<div class="col-lg-3">
<label for="exampleInputPassword1">Status:</label>
<select id="BANCO_STATUS" name="BANCO_STATUS" class="form-control">
<?php 
IF($BANCO_STATUS == '1')
...
<textarea rows="4" class="form-control" id="BANCO_OBS" name="BANCO_OBS" placeholder="insira a observação"><?php echo $BANCO_OBS ; ?></textarea>
</div>
