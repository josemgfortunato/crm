...
echo "action='consumidor-protocolo-cadastrar-actions.php'"; 
elseif($ID_CONSUMIDOR_PROTOCOLO > '')
echo "action='consumidor-protocolo-alterar-actions.php'"; 
?> method='post' enctype="multipart/form-data" name="formulario" >
<input type="hidden" id="ID_CONSUMIDOR_PROTOCOLO" name="ID_CONSUMIDOR_PROTOCOLO" value="<?php echo $ID_CONSUMIDOR_PROTOCOLO; ?>">
<input type="hidden" id="CONSUMIDOR_PROTOCOLO_USER" name="CONSUMIDOR_PROTOCOLO_USER" value="<?php echo $ID_USER; ?>">
<input type="hidden" id="CONSUMIDOR_PROTOCOLO_LEADS" name="CONSUMIDOR_PROTOCOLO_LEADS" value="<?php echo $ID_LEADS; ?>">
<input type="hidden" id="F_USER_REGISTRO" name="F_USER_REGISTRO" value="<?php echo $USER_NOME; ?>">


<div class="row">
<div class="col-lg-5">
<label for="exampleInputPassword1">Nº do Consumidor/Protocolo:</label>
<input type="text" class="form-control" id="CONSUMIDOR_PROTOCOLO_N" name="CONSUMIDOR_PROTOCOLO_N" value="<?php echo $CONSUMIDOR_PROTOCOLO_N; ?>" required>
</div>


<div class="col-lg-5">
<label for="exampleInputEmail1">Arquivo/ Doc's:</label>
<input type="file" name="CONSUMIDOR_PROTOCOLO_ARQUIVO" id="CONSUMIDOR_PROTOCOLO_ARQUIVO" />
<input type="hidden" id="VALIDA_CONSUMIDOR_PROTOCOLO_ARQUIVO" name="VALIDA_CONSUMIDOR_PROTOCOLO_ARQUIVO" value="<?php echo $CONSUMIDOR_PROTOCOLO_ARQUIVO; ?>">
</div>
...
<textarea rows="4" class="form-control" id="CONSUMIDOR_PROTOCOLO_OBS" name="CONSUMIDOR_PROTOCOLO_OBS" placeholder="insira a observação"><?php echo $CONSUMIDOR_PROTOCOLO_OBS; ?></textarea>
</div>
