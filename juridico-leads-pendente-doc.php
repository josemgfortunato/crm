...
$LEADS_JURIDICO_SENHA_GOV		= isset($val_leads_juri->LEADS_JURIDICO_SENHA_GOV) ? $val_leads_juri->LEADS_JURIDICO_SENHA_GOV : '';
...
///////////////////////////////////////////////////////
$sql_result_doc = mysqli_query($conexao,"select * from tb_leads_juridico_doc WHERE ID_LEADS_JURIDICO_DOC = '$ID_LEADS_JURIDICO_DOC' ");
$val_juridico_doc = mysqli_fetch_object($sql_result_doc);  
///////////////////////////////////////////////////////
$ID_LEADS_JURIDICO_DOC 			= isset($val_juridico_doc->ID_LEADS_JURIDICO_DOC) ? $val_juridico_doc->ID_LEADS_JURIDICO_DOC : '';
$LEADS_JURIDICO_DOC_USER 			= isset($val_juridico_doc->LEADS_JURIDICO_DOC_USER) ? $val_juridico_doc->LEADS_JURIDICO_DOC_USER : '';
$LEADS_JURIDICO_DOC_STATUS		= isset($val_juridico_doc->LEADS_JURIDICO_DOC_STATUS) ? $val_juridico_doc->LEADS_JURIDICO_DOC_STATUS : '';
$LEADS_JURIDICO_DOC_LEADS			= isset($val_juridico_doc->LEADS_JURIDICO_DOC_LEADS) ? $val_juridico_doc->LEADS_JURIDICO_DOC_LEADS : '';
$LEADS_JURIDICO_DOC_TIPO			= isset($val_juridico_doc->LEADS_JURIDICO_DOC_TIPO) ? $val_juridico_doc->LEADS_JURIDICO_DOC_TIPO : '';
$LEADS_JURIDICO_DOC_ARQUIVO		= isset($val_juridico_doc->LEADS_JURIDICO_DOC_ARQUIVO) ? $val_juridico_doc->LEADS_JURIDICO_DOC_ARQUIVO : '';
$LEADS_JURIDICO_DOC_OBS 			= isset($val_juridico_doc->LEADS_JURIDICO_DOC_OBS) ? $val_juridico_doc->LEADS_JURIDICO_DOC_OBS : '';
...
echo "action='juridico-leads-pendente-alterar-actions.php'"; 
...
<input type="hidden" id="LEADS_JURIDICO_USER" name="LEADS_JURIDICO_USER" value="<?php echo $ID_USER; ?>">
<input type="hidden" id="LEADS_JURIDICO_LEADS" name="LEADS_JURIDICO_LEADS" value="<?php echo $ID_LEADS; ?>">
...
<div class="col-lg-2">
<label for="exampleInputPassword1">Senha GOV.:</label>
<input type="text" id="LEADS_JURIDICO_SENHA_GOV" name="LEADS_JURIDICO_SENHA_GOV" class="form-control" value="<?php echo $LEADS_JURIDICO_SENHA_GOV; ?>" >
</div>

<div class="col-lg-2">
<label for="exampleInputPassword1">Status Doc:</label>
<select id="LEADS_JURIDICO_STATUS_DOC" name="LEADS_JURIDICO_STATUS_DOC" class="form-control" required />
<?php 
...
<form 
<?php 
if($ID_LEADS_JURIDICO_DOC == '')
echo "action='juridico-doc-cadastrar-actions.php'"; 
elseif($ID_LEADS_JURIDICO_DOC > '')
echo "action='juridico-doc-alterar-actions.php'"; 
?> method='post' enctype="multipart/form-data" name="formulario" >
<input type="hidden" id="ID_LEADS_JURIDICO_DOC" name="ID_LEADS_JURIDICO_DOC" value="<?php echo $ID_LEADS_JURIDICO_DOC; ?>">
<input type="hidden" id="LEADS_JURIDICO_DOC_USER" name="LEADS_JURIDICO_DOC_USER" value="<?php echo $ID_USER; ?>">
<input type="hidden" id="LEADS_JURIDICO_DOC_LEADS" name="LEADS_JURIDICO_DOC_LEADS" value="<?php echo $ID_LEADS; ?>">
<input type="hidden" id="F_USER_REGISTRO" name="F_USER_REGISTRO" value="<?php echo $USER_NOME; ?>">
...
<select id="LEADS_JURIDICO_DOC_STATUS" name="LEADS_JURIDICO_DOC_STATUS" class="form-control" required />
<?php 
if($LEADS_JURIDICO_DOC_STATUS == '1')
echo "<option value='1'> OK </option>";
elseif($LEADS_JURIDICO_DOC_STATUS == '2')
...
<select id="LEADS_JURIDICO_DOC_TIPO" name="LEADS_JURIDICO_DOC_TIPO" class="form-control" required />
<?php 
if($LEADS_JURIDICO_DOC_TIPO == '1')
echo "<option value='1'> Contrato Assinado </option>";
elseif($LEADS_JURIDICO_DOC_TIPO == '2')
echo "<option value='2'> CNH </option>";
elseif($LEADS_JURIDICO_DOC_TIPO == '3')
echo "<option value='3'> RG </option>";
elseif($LEADS_JURIDICO_DOC_TIPO == '4')
echo "<option value='4'> CPF </option>";
elseif($LEADS_JURIDICO_DOC_TIPO == '5')
echo "<option value='5'> Contrato Financiamento </option>";
elseif($LEADS_JURIDICO_DOC_TIPO == '6')
echo "<option value='6'> Doc. do Veículo </option>";
elseif($LEADS_JURIDICO_DOC_TIPO == '7')
echo "<option value='7'> Ultima Parcela Paga </option>";
elseif($LEADS_JURIDICO_DOC_TIPO == '8')
echo "<option value='8'> Comprovante de Endereço </option>";
elseif($LEADS_JURIDICO_DOC_TIPO == '9')
...
<input type="file" name="LEADS_JURIDICO_DOC_ARQUIVO" id="LEADS_JURIDICO_DOC_ARQUIVO" />
<input type="hidden" id="VALIDA_LEADS_JURIDICO_DOC_ARQUIVO" name="VALIDA_LEADS_JURIDICO_DOC_ARQUIVO" value="<?php echo $LEADS_JURIDICO_DOC_ARQUIVO; ?>">
</div>
...
<textarea rows="4" class="form-control" id="LEADS_JURIDICO_DOC_OBS" name="LEADS_JURIDICO_DOC_OBS" placeholder="insira a observação"><?php echo $LEADS_JURIDICO_DOC_OBS; ?></textarea>
</div>
...
$sql_c_doc = mysqli_query($conexao,"SELECT * FROM tb_leads_juridico_doc WHERE LEADS_JURIDICO_DOC_LEADS = '$ID_LEADS' AND LEADS_JURIDICO_DOC_STATUS < '3' ORDER BY ID_LEADS_JURIDICO_DOC DESC ");
while($val_c_doc = mysqli_fetch_object($sql_c_doc)):      

$ID_LEADS_JURIDICO_DOC			= isset($val_c_doc->ID_LEADS_JURIDICO_DOC) ? $val_c_doc->ID_LEADS_JURIDICO_DOC : '';
$LEADS_JURIDICO_DOC_STATUS		= isset($val_c_doc->LEADS_JURIDICO_DOC_STATUS) ? $val_c_doc->LEADS_JURIDICO_DOC_STATUS : '';
$LEADS_JURIDICO_DOC_LEADS			= isset($val_c_doc->LEADS_JURIDICO_DOC_LEADS) ? $val_c_doc->LEADS_JURIDICO_DOC_LEADS : '';
$LEADS_JURIDICO_DOC_TIPO			= isset($val_c_doc->LEADS_JURIDICO_DOC_TIPO) ? $val_c_doc->LEADS_JURIDICO_DOC_TIPO : '';
$LEADS_JURIDICO_DOC_ARQUIVO		= isset($val_c_doc->LEADS_JURIDICO_DOC_ARQUIVO) ? $val_c_doc->LEADS_JURIDICO_DOC_ARQUIVO : '';
////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////
...
?>
<tr>
<td ><div align="center"><?php echo $ID_LEADS_JURIDICO_DOC; ?></div></td>
<td >
<?php 
if($LEADS_JURIDICO_DOC_TIPO == '1')
...
<td><div align="center"><a href="juridico-docs/<?php echo $LEADS_JURIDICO_DOC_ARQUIVO; ?>" target="_blank"><i class="fa fa-download" style="color:#006600"></i></a></div></td>
<td><div align="center"><a href="juridico-leads-pendente-doc.php?ID_LEADS=<?php echo $ID_LEADS; ?>&&ID_LEADS_JURIDICO_DOC=<?php echo $ID_LEADS_JURIDICO_DOC; ?>"><i class="fa fa-refresh"></i></a></div></td>
<td><div align="center"><a href="excluir-juridico-doc.php?ID_LEADS=<?php echo $ID_LEADS; ?>&&ID_LEADS_JURIDICO_DOC=<?php echo $ID_LEADS_JURIDICO_DOC; ?>"><i class="fa fa-close" style="color:#FF0000"></i></a></div></td>
</tr>
<?php
 endwhile;
?>
