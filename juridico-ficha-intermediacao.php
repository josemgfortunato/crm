...
ELSEIF($ID_FICHA_INTER > '')
echo "action='operador-ficha-intermediacao-alterar-actions.php'"; 
...
<!--
<select id="CLIENTE_UF" name="CLIENTE_UF" class="form-control" readonly />
...
<input type="text" class="form-control" id="FICHA_INTER_PAGA" name="FICHA_INTER_PAGA" placeholder="insira as parcelas pagas " value="<?php echo $CALCULO_QTDE_PARCELAS; ?>" readonly />
</div>
...
$VALOR_CONTR_DATA_PGTO			 	= isset($val_valor->VALOR_CONTR_DATA_PGTO) ? $val_valor->VALOR_CONTR_DATA_PGTO : '';	
?>
<div class="box box-danger">
<div class="box-header with-border">
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
...
<input type="text" class="form-control" id="VALOR_CONTR_QTDE_VEZES" name="VALOR_CONTR_QTDE_VEZES" placeholder="insira qtde vezes " value="<?php echo $VALOR_CONTR_QTDE_VEZES; ?>" >
</div>

<div class="col-lg-2">
<label for="exampleInputPassword1">Parcela:</label>
<input type="text" class="form-control" id="VALOR_CONTR_PARCELA" name="VALOR_CONTR_PARCELA" placeholder="insira as parcelas " value="<?php echo $VALOR_CONTR_PARCELA; ?>" >
</div>

<div class="col-lg-2">
<label for="exampleInputPassword1">Data Pagamento:</label>
<input type="text" class="form-control" id="VALOR_CONTR_DATA_PGTO" name="VALOR_CONTR_DATA_PGTO" placeholder="insira a data de fechamento " value="<?php echo $VALOR_CONTR_DATA_PGTO; ?>" >
</div>
