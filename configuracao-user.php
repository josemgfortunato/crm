...
///////////////////////////////////////////////////////
$sql_result = mysqli_query($conexao,"select * from tb_administrador WHERE ID_ADMINISTRADOR = '$ID_USER' ");
...
$ADMINISTRADOR_FOTO		 		= isset($val_user->ADMINISTRADOR_FOTO) ? $val_user->ADMINISTRADOR_FOTO : '';
...
function readURL(input) {
  ...
  $(document).ready(function(e) {
    $("input[name='ADMINISTRADOR_FOTO']").change(function(){
      readURL(this);
    });
...
echo "action='configuracao-user-alterar-actions.php'"; 
...
<input type="text" class="form-control" id="ADMINISTRADOR_NOME" name="ADMINISTRADOR_NOME" placeholder="Insira o Nome" value="<?php echo $ADMINISTRADOR_NOME ; ?>" readonly>
</div>
...
<input type="email" class="form-control" id="ADMINISTRADOR_EMAIL" name="ADMINISTRADOR_EMAIL" placeholder="Insira o E-mail" value="<?php echo $ADMINISTRADOR_EMAIL; ?>" readonly>
</div>


<div class="col-lg-3">
<label for="exampleInputPassword1">Senha:</label>
<input type="password" class="form-control" id="ADMINISTRADOR_SENHA" name="ADMINISTRADOR_SENHA" placeholder="Insira a Senha" value="<?php echo $ADMINISTRADOR_SENHA; ?>" readonly>
</div>

<div class="col-lg-2">
<label for="exampleInputPassword1">Status:</label>
<select id="ADMINISTRADOR_STATUS" name="ADMINISTRADOR_STATUS" class="form-control" readonly>
<?php 
...
<select id="ADMINISTRADOR_TIPO" name="ADMINISTRADOR_TIPO" class="form-control" readonly>
<?php 
...
<div class="row">
<div class="col-lg-8">
<label for="exampleInputEmail1">Foto - tamanho 215x215 pixels:</label>
<input type="file" name="ADMINISTRADOR_FOTO" id="ADMINISTRADOR_FOTO" />
<input type="hidden" id="VALIDA_ADMINISTRADOR_FOTO" name="VALIDA_ADMINISTRADOR_FOTO" value="<?php echo $ADMINISTRADOR_FOTO; ?>">
<table width="350">
  <tr>
    <td width="120">
    <?php 
if($ADMINISTRADOR_FOTO > '')
echo "<img src='fotos-operador/$ADMINISTRADOR_FOTO' width='100' height='90' id='obras1'>";
else
echo "<img / src='dist/img/icone-user.png' width='100' height='90' id='preview'>";
?>
	</td>
    <td>
    <font color="#FF0000">remover foto 1:</font>
    <input type='checkbox' style="background-color:#f5f5f5" id='F_EXC_1' name='F_EXC_1' value='1' />
    </td>
  </tr>
</table>                        
</div>
...
<textarea rows="4" class="form-control" id="ADMINISTRADOR_OBS" name="ADMINISTRADOR_OBS" placeholder="Insira a Observação" readonly><?php echo $ADMINISTRADOR_OBS ; ?></textarea>
</div>
