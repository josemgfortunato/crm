...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Jurídico - Consumidor Pendente |
        <small>painel de controle</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="#">Jurídico - Consumidor Pendente</a></li>
      </ol>
    </section>
<br>
  <!-- Main content -->
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="78%"><h3 class="box-title">Tabela - Consumidor Pendente
<strong>
<?php
//if($val_status == '1')
//echo ' - " Laudo Fechado " ';
...
$sql_juri_result = mysqli_query($conexao,"select * from tb_leads_juridico WHERE $val_user (LEADS_JURIDICO_STATUS_DOC = '1' AND LEADS_JURIDICO_CONSUMIDOR_ENVIADO = '1' AND LEADS_JURIDICO_CONSUMIDOR_RECEBIDO = '1' AND LEADS_JURIDICO_STATUS = '6') ORDER BY ID_LEADS_JURIDICO DESC ");
//$sql_juri_result = mysqli_query($conexao,"select * from tb_leads_juridico WHERE $val_user (LEADS_JURIDICO_STATUS = '' AND LEADS_JURIDICO_CONSUMIDOR_ENVIADO = '') ORDER BY ID_LEADS_JURIDICO DESC ");
//$sql_juri_result = mysqli_query($conexao,"select * from tb_leads_juridico WHERE $val_user (LEADS_JURIDICO_STATUS = '' OR LEADS_JURIDICO_STATUS = '2') ORDER BY ID_LEADS_JURIDICO DESC ");
...
///////////////////////////////////////////////////////////////////////////////////////
$sql_con_prot = mysqli_query($conexao,"select * from tb_consumidor_protocolo WHERE CONSUMIDOR_PROTOCOLO_LEADS = '$LEADS_JURIDICO_LEADS' ");
$val_con_prot = mysqli_fetch_object($sql_con_prot);  
///////////////////////////////////////////////////////
$ID_CONSUMIDOR_PROTOCOLO		= isset($val_con_prot->ID_CONSUMIDOR_PROTOCOLO) ? $val_con_prot->ID_CONSUMIDOR_PROTOCOLO : '';
//if($LEADS_JURIDICO_STATUS != '1')	{



$follow = mysqli_query($conexao,"select * from tb_leads_juridico_hist WHERE LEADS_JURIDICO_HIST_LEADS = '$ID_LEADS' ORDER BY ID_LEADS_JURIDICO_HIST DESC ");
$valida_follow = mysqli_fetch_object($follow);  

$ID_LEADS_JURIDICO_HIST 			= isset($valida_follow->ID_LEADS_JURIDICO_HIST) ? $valida_follow->ID_LEADS_JURIDICO_HIST : '';
$LEADS_JURIDICO_HIST_DATA_FOLLOW 	= isset($valida_follow->LEADS_JURIDICO_HIST_DATA_FOLLOW) ? $valida_follow->LEADS_JURIDICO_HIST_DATA_FOLLOW : '';
...
$LEADS_JURIDICO_HIST_HORA_FOLLOW 	= isset($valida_follow->LEADS_JURIDICO_HIST_HORA_FOLLOW) ? $valida_follow->LEADS_JURIDICO_HIST_HORA_FOLLOW : '';
?>
...
?> </div></td>
<td><div align="center"><?php echo $LEADS_JURIDICO_HIST_DATA_FOLLOW; ?></div></td>
<td><div align="center"><?php echo $LEADS_JURIDICO_HIST_HORA_FOLLOW; ?></div></td>
<!--
<td><div align="center"> <?php echo $LEADS_JURIDICO_ENVIO_DATA; ?> </div></td>
-->
<td><div align="center"><a href="juridico-ficha-intermediacao.php?ID_LEADS=<?php echo $ID_LEADS; ?>&&ID_LEADS_JURIDICO=<?php echo $ID_LEADS_JURIDICO; ?>"><i class="fa fa-clipboard" style="color:#00FF00"></i></a></div></td>
...
<td><div align="center"><a href="juridico-consumidor-protocolo-visualiza.php?ID_LEADS=<?php echo $ID_LEADS; ?>&&ID_LEADS_JURIDICO=<?php echo $ID_LEADS_JURIDICO; ?>"><i class="fa fa-clipboard" style="color:#003300"></i></a></div></td>

<td><div align="center"><a href="laudo-juridico.php?ID_LEADS=<?php echo $ID_LEADS; ?>"><i class="fa fa-folder-open" style="color:#ff0000"></i></a></div></td>
</td>
<?php
if($USER_TIPO == '1')
