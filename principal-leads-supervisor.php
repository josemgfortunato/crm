...
<td width="5%">&nbsp;&nbsp;</td>
    <td width="22%">
            <div align="right">
            <form action="leads-supervisor.php" >
...
<td width="5%">&nbsp;&nbsp;</td>
    <td width="22%">
            <div align="right">
            <form action="leads-supervisor-massa.php" >
...
$sql_leads = mysqli_query($conexao,"select * from tb_leads WHERE $val_user LEADS_STATUS = '' LIMIT 500 ");
