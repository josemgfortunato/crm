  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="#">Lead's Operador ADM</a></li>
      </ol>
    </section>
<br>
  <!-- Main content -->
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="78%"><h3 class="box-title">Tabela de Lead's Operador ADM
<strong>
<?php
//if($val_status == '1')
...
<th width="40"><div align="center">ENV. JUR.</div></th>
...
$sql_leads_op = mysqli_query($conexao,"select * from tb_leads_op_adm WHERE $val_user (OP_ADM_STATUS = '') ORDER BY ID_OP_ADM DESC LIMIT 500 ");
...
$OP_ADM_FATURAMENTO	= isset($val_leads_op->OP_ADM_FATURAMENTO) ? $val_leads_op->OP_ADM_FATURAMENTO : '';
...
<div align="center">
<?php
if(($OP_ADM_FATURAMENTO > '') and ($ID_LEADS_OP_ADM_DOC > ''))	{
?>
<a href="op-adm-enviar-juridico.php?ID_LEADS=<?php echo $ID_LEADS; ?>"><i class="fa fa-paper-plane-o" style="color:#003300"></i></a></div>
<?php
	}
?>	
</td>
