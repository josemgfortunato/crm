...
$sql_leads = mysqli_query($conexao,"select * from tb_leads WHERE $val_user LEADS_PRIORIDADE < '6' AND (LEADS_STATUS = '' OR LEADS_STATUS = '2' OR LEADS_STATUS = '3') ORDER BY LEADS_PRIORIDADE DESC LIMIT 500 ");
}
